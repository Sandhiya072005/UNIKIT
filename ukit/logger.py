...
r"""
The ukit.logger module provides the core logging facilities for UKIT.
It sets up the console and (optionally) a log file.  For early debugging,
it checks the UKIT_DEBUG, UKIT_LOG, and UKIT_LOG_LEVEL environment
variables.
"""
...
def version_string():
    args = (CHIRP_VERSION,
            ...
            sys.version.split()[0])
    return "UKIT %s on %s (Python %s)" % args
